...
namespace pbrt{
    ...
    bool InfiniteSphereDE::Intersect(const Ray &r, Float *tHit, SurfaceInteraction *isect, bool testAlphaTexture) const {
    ...
    Float InfiniteSphereDE::Area() const { return 4 * 3.1415926 * radius * radius; }
    ...
    std::shared_ptr<Shape> CreateInfiniteSphereDEShape(const Transform *o2w,
        ...
        InfiniteSphereDEParams DEparams;
        ...
        return std::make_shared<InfiniteSphereDE>(o2w, w2o, reverseOrientation, DEparams, radius);
    }
