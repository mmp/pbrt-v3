...
#ifndef PBRT_SHAPES_INFINITESPHEREDE_H
#define PBRT_SHAPES_INFINITESPHEREDE_H
...
namespace pbrt {
    ...
    class InfiniteSphereDE : public DistanceEstimator{
    public:
        InfiniteSphereDE(const Transform *ObjectToWorld, const Transform *WorldToObject,
                 bool reverseOrientation, const InfiniteSphereDEParams DEparams, Float radius):
    ...
    protected:
        const InfiniteSphereDEParams DEparams;
        const Float radius;
